...
[觀看 SPOTIFIVE 實際操作展示（YouTube）](https://www.youtube.com/watch?v=-vAtLdPzTkA)

此影片為 2023 年課程專題完成時錄製的實際操作畫面，可查看商品瀏覽、購物車及網站主要功能。影片反映當時完成的版本；目前 repository 則是移除個資與未確認授權素材後的整理版本。
