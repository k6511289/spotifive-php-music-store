<?php
    ...
    if (isset($_POST['add'])) {
        ...
        $result = mysqli_query($link, "SELECT COUNT(*) AS total FROM english_album");
        $totalRecords = 0;
        if ($result) {
        ...
        $mypath = './english_album_each_page/photo/';
        ...
        $sql = "INSERT INTO english_album (no, name, price,description,img) VALUES ('".$totalRecords."','".$name."','".$price."','".$content."','".$totalRecords.".jpg')";
